...
$i=1;
  ...
  var all_questions = [{
    question_string: "<?php $fetched_row['question'];?>",
    choices: {
    correct: "<?php echo $fetched_row['correct']; ?>",
      wrong: ["<?php echo $fetched_row['a1']; ?>", "<?php echo $fetched_row['a2']; ?>", "<?php echo $fetched_row['a3']; ?>"]
    }
}];
<?php } ?>
