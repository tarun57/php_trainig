					...
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list">
							<a href="#"><i class="lnr lnr-cog"></i>
								<span>Weight</span></a>
								<ul class="sub-menu-list">
									<li><a href="create_weight.php">Create Weight</a> </li>
...
<?php
                                       ...
                                       echo $cat_image = $_FILES['cat_image']['name'];
                                        ...
                                        $query = "insert into category(cat_image,cat_name,cat_desc)"
                                                . " values('$cat_image','$cat_name','$cat_desc')";
                                        $run = mysql_query($query);
                                        
                                        if($run){
                                            echo "<script>alert('New Subcategory is Added.')</script>";
