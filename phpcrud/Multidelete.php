					...
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list">
							<a href="#"><i class="lnr lnr-cog"></i>
								...
								<ul class="sub-menu-list">
									<li><a href="create_subcategory.php">Create Subcategory</a> </li>
						 ...
						 <li class="menu-list">
							<a href="#"><i class="lnr lnr-cog"></i>
								<span>Child Subcategory</span></a>
								<ul class="sub-menu-list">
									<li><a href="create_childsubcategory.php">Create Child Subcategory</a> </li>
									<li><a href="view_childsubcategory.php">View Child Subcategory</a></li>
								</ul>
						</li>
...
<?php
  ...
  <div class="form-group">
	...
	<img src="../images/<?php echo $cat_image;?>" width="100px" height="100px">
  </div><br>
  <br>
 
  <div class="form-group">
    <label for="pwd">Catgory Name:</label>
  ...
  <br>
   <div class="form-group">
    ...
    <input type="text" name="cat_desc" value="<?php echo $cat_desc;?>" class="form-control">
  </div>
  ...
  <input type="submit" name="submit" class="btn btn-default">
										...
										$query=mysql_query("update category set cat_image='$cat_image',cat_name='$cat_name',cat_desc='$cat_desc' where cat_id='$cat_id'");
										}
										else
										{
										
						$query=mysql_query("update category set cat_name='$cat_name',cat_desc='$cat_desc' where cat_id='$cat_id'");
