...
#horizontal-form {
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">LIST OF SUBCATEGORY</h3>
						<div class="tab-content">
                                    ...
                                    <table class="table table-striped table-hover table-bordered">
										...
										<?php
                                            ...
                                            <tr class="response">
											<td><img src="../images/<?php echo $cat_image;?>" width="100px" height="100px"></td>
                                            <td><?php echo $cat_name;?></td>
											<td><?php echo $cat_desc;?></td>
												 <td>
											 <a href="#">view</a>|
											 <a href="update_category.php?cat_id=<?php echo $cat_id;?>">update</a>|
											 <a href="delete_category.php?cat_id=<?php echo $cat_id;?>">Delete</a>
