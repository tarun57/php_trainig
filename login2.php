        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
					...
					<strong><a href="http://localhost/web/index.php#tologin" style="color:white;">Login</a></strong>
					<strong><a href="http://localhost/web/index.php#toregister" style="color:white; ">Signup</a></strong>
                </div>
